<br />
<p align="center">
  <a href="https://github.com/aleksandar1202/next-e-commerce">
  ...
  <p align="center">
    An e-commerce website built with Next.js that I made as a self challenge. There are some issues that I will handle later. Using Firebase as backend.
    <br />
    <br />
...
I saw a UI design on Dribbble and I decided to make it a full working website with NextJS. Some issues are still there but I will check out them later.
...
```sh
git clone https://github.com/aleksandar1202/next-e-commerce.git
cd next-e-commerce
```
